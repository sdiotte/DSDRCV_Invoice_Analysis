...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__1_scatter_matrix(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_2:;
    {
...

        {
            ...
            tmp_call_result_3 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_call_result_6 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__3_radviz(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...

    {
...

        {
            ...
            tmp_call_result_5 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
        if (tmp_call_result_5 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__4_andrews_curves(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_2:;
    {
...

        {
            ...
            tmp_call_result_4 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
        if (tmp_call_result_4 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__5_bootstrap_plot(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_call_result_6 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_call_result_6 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_call_result_8 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_call_result_8 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_call_result_10 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_call_result_10 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_call_result_12 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_call_result_12 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__6_parallel_coordinates(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1, tmp_dircall_arg4_1};
            tmp_call_result_2 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
        if (tmp_call_result_2 == NULL) {
            assert(ERROR_OCCURRED());
