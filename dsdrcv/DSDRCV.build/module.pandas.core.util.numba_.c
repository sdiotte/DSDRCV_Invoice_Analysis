...
static PyObject *impl_pandas$core$util$numba_$$$function__4_jit_user_function$$$function__1_numba_func(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        PyObject *tmp_expression_value_3;
        tmp_expression_value_1 = GET_STRING_DICT_VALUE(moduledict_pandas$core$util$numba_, (Nuitka_StringObject *)mod_consts[22]);
        ...
        tmp_name_value_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_2, mod_consts[24]);
        ...
        tmp_expression_value_3 = GET_STRING_DICT_VALUE(moduledict_pandas$core$util$numba_, (Nuitka_StringObject *)mod_consts[25]);
