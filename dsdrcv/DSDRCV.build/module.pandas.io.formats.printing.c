...
static PyObject *impl_pandas$io$formats$printing$$$function__1_adjoin(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    tmp_for_loop_1__for_iterator = NULL;
    {
...

        {
            ...
            tmp_assign_source_20 = impl___main__$$$function__10_complex_call_helper_star_list(dir_call_args);
        }
    ...
    }
    {
        ...
        }
        {
...

            {
                ...
                tmp_append_value_1 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
            }
            if (tmp_append_value_1 == NULL) {
                assert(ERROR_OCCURRED());
...
static PyObject *impl_pandas$io$formats$printing$$$function__4__pprint_dict(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...

    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1, tmp_dircall_arg4_1};
            tmp_kw_call_value_0_1 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
...

        {
            ...
            tmp_kw_call_value_1_1 = impl___main__$$$function__3_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_6, mod_consts[165]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_2:;
    {
        ...
        tmp_tuple_element_5 = BUILTIN_GETATTR(tmp_expression_value_9, tmp_name_value_3, tmp_default_value_1);
