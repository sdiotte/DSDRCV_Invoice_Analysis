...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("numpy.dtypes"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_numpy$dtypes(void) {
...
static PyObject *impl_numpy$dtypes$$$function__1__add_dtype_helper(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_bf2bee683580ad64bcf7478f005c8db3 = MAKE_FUNCTION_FRAME(codeobj_bf2bee683580ad64bcf7478f005c8db3, module_numpy$dtypes, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_bf2bee683580ad64bcf7478f005c8db3);
    ...
    }
    {
        ...
        tmp_name_value_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_2, mod_consts[4]);
...
PyObject *modulecode_numpy$dtypes(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_numpy$dtypes);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_6138adf058350c4955a8187190adec4c);
