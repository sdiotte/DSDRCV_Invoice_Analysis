...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_3, mod_consts[212]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_5, mod_consts[214]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_2:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_5 = LOOKUP_ATTRIBUTE(tmp_expression_value_7, mod_consts[216]);
