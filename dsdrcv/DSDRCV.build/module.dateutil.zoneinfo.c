...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_7, mod_consts[78]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_2:;
    {
        ...
        tmp_tuple_element_3 = BUILTIN_GETATTR(tmp_expression_value_10, tmp_name_value_5, tmp_default_value_1);
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_13, mod_consts[78]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_15, mod_consts[79]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_5:;
    {
        ...
        tmp_tuple_element_6 = BUILTIN_GETATTR(tmp_expression_value_16, tmp_name_value_6, tmp_default_value_2);
