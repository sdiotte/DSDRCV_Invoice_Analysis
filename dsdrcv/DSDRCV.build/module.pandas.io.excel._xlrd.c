...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_2, mod_consts[78]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_4, mod_consts[80]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_end_1:;
    {
        ...
        // Framed code:
        {
            ...
            tmp_expression_value_7 = PyObject_GetItem(locals_pandas$io$excel$_xlrd$$$class__1_XlrdReader_19, mod_consts[74]);

            if (tmp_expression_value_7 == NULL) {
                if (CHECK_AND_CLEAR_KEY_ERROR_OCCURRED()) {
                    tmp_expression_value_7 = GET_STRING_DICT_VALUE(moduledict_pandas$io$excel$_xlrd, (Nuitka_StringObject *)mod_consts[74]);
