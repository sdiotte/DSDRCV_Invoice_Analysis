...
static PyObject *impl_numpy$core$overrides$$$function__2_verify_matching_signatures(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_733eb2298b67b84ac3bbd54f2f7c5a82)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_733eb2298b67b84ac3bbd54f2f7c5a82 = MAKE_FUNCTION_FRAME(codeobj_733eb2298b67b84ac3bbd54f2f7c5a82, module_numpy$core$overrides, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_733eb2298b67b84ac3bbd54f2f7c5a82);
...
static PyObject *impl_numpy$core$overrides$$$function__3_array_function_dispatch$$$function__1_decorator(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_23f03f7c28bdc8a04434271001bad62c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_23f03f7c28bdc8a04434271001bad62c = MAKE_FUNCTION_FRAME(codeobj_23f03f7c28bdc8a04434271001bad62c, module_numpy$core$overrides, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_23f03f7c28bdc8a04434271001bad62c);
    ...
    }
    {
        ...
        tmp_add_expr_left_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_2, mod_consts[21]);
    ...
    branch_yes_4:;
    {
        ...
        tmp_or_left_value_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_7, mod_consts[0]);
...
static PyObject *impl_numpy$core$overrides$$$function__4_array_function_from_dispatcher$$$function__1_decorator(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b8d2d75269d4cde70325577960e2f83e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b8d2d75269d4cde70325577960e2f83e = MAKE_FUNCTION_FRAME(codeobj_b8d2d75269d4cde70325577960e2f83e, module_numpy$core$overrides, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b8d2d75269d4cde70325577960e2f83e);
