...
static PyObject *impl_pandas$core$ops$missing$$$function__1__fill_zeros(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_e741e5294f094d386520e2458c7a07bd = MAKE_FUNCTION_FRAME(codeobj_e741e5294f094d386520e2458c7a07bd, module_pandas$core$ops$missing, sizeof(nuitka_bool)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    }
    {
        ...
        tmp_operand_value_1 = (var_is_variable_type == NUITKA_BOOL_TRUE) ? Py_True : Py_False;
