...
static PyObject *impl_pandas$core$window$common$$$function__1_flex_binary_moment(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_kw_call_arg_value_0_2 = impl___main__$$$function__14__unpack_list(dir_call_args);
        }
    ...
    branch_no_3:;
    {
        ...
        }
        {
...

            {
                ...
                tmp_dictset38_value_1 = impl___main__$$$function__10_complex_call_helper_star_list(dir_call_args);
            }
