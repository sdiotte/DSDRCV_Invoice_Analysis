...
static PyObject *impl_numpy$polynomial$polynomial$$$function__23__str_term_unicode(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b87f8b0bffda75343929458369b1165b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b87f8b0bffda75343929458369b1165b = MAKE_FUNCTION_FRAME(codeobj_b87f8b0bffda75343929458369b1165b, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b87f8b0bffda75343929458369b1165b);
...
static PyObject *impl_numpy$polynomial$polynomial$$$function__24__str_term_ascii(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_8e417010fbcbe5f55e0375f0f93a39ab)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_8e417010fbcbe5f55e0375f0f93a39ab = MAKE_FUNCTION_FRAME(codeobj_8e417010fbcbe5f55e0375f0f93a39ab, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_8e417010fbcbe5f55e0375f0f93a39ab);
...
static PyObject *impl_numpy$polynomial$polynomial$$$function__25__repr_latex_term(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_f8d5264ff40fab990fd09a9c9b871d52)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_f8d5264ff40fab990fd09a9c9b871d52 = MAKE_FUNCTION_FRAME(codeobj_f8d5264ff40fab990fd09a9c9b871d52, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_f8d5264ff40fab990fd09a9c9b871d52);
