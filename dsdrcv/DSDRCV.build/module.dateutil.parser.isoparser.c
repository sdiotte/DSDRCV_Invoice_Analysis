...
static PyObject *impl_dateutil$parser$isoparser$$$function__1__takes_ascii$$$function__1_func(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
        ...
        tmp_called_value_1 = BUILTIN_GETATTR(tmp_expression_value_1, tmp_name_value_1, tmp_default_value_1);
...
static PyObject *impl_dateutil$parser$isoparser$$$function__3_isoparse(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_add_expr_left_3 = impl___main__$$$function__10_complex_call_helper_star_list(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_4, mod_consts[129]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_assign_source_24 = LOOKUP_ATTRIBUTE(tmp_expression_value_7, mod_consts[123]);
